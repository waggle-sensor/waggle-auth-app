...
PELICAN_KEY = env("PELICAN_KEY", str, "")
PELICAN_ALGORITHM = env("PELICAN_ALGORITHM", str, "ES256")
PELICAN_KEY_ID = env("PELICAN_KEY_ID", str, "")
PELICAN_ISSUER = env("PELICAN_ISSUER", str, "")
PELICAN_LIFETIME = env("PELICAN_LIFETIME", int, 60)
PELICAN_ROOT_URL = env("PELICAN_ROOT_URL", str, "")
PELICAN_ROOT_FOLDER = env("PELICAN_ROOT_FOLDER", str, "")
